...
def test_generic_rubric_titles_are_not_undated_assignments():
    # 배치4 gold가 경계 확정: 범주·복수 라벨('Assignments'/'과제'/'Individual
    # Assignments')은 무기한과제가 아니다 (B4-007/009/013/030/033 gold 빈칸).
    # 관용 단일 산출물명 'Homework'만 예외로 통과 (B4-016/021 gold).
    doc = ("성적: 과제 20% Assignments Attendance, Presentation, and Class Participation "
           "IC-PBL Term Project Homework Individual Assignments")
    ...
    assert undated == ["IC-PBL Term Project", "Homework"]
